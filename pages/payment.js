    ...
    <Layout title="Login">
      <form className="max-auto max-w-screen-md">
        ...
        <div className="flex items-center mb-4">
          ...
          <label className="mx-1.5" for="html">PayPal</label> <br />
        </div>
        <div className="flex items-center mb-4">
          <input type="radio" id="stripe" name="payment" value="stripe" />
          <label className="mx-1.5" for="html">Stripe</label> <br />
        </div>
        <div className="flex items-center mb-4">
          <input type="radio" id="cod" name="payment" value="cod" />
          <label className="mx-1.5" for="html">Cash On Delivery</label> <br />
        </div>
<div className="flex">
